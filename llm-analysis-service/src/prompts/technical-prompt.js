function getTechnicalPrompt(type, data) {
    switch (type) {
      case 'summary':
        return `Generate a technical summary of website performance based on Lighthouse data:
  ...
  Format as a technical report with metrics and specific recommendations.`;
      ...
      case 'detailed':
        return `Provide a detailed technical analysis of the website's performance:
  ...
  Provide specific, actionable recommendations with implementation details.`;
      ...
      case 'architecture':
        return `Analyze the technical architecture of this website:
  ...
  Provide recommendations for architectural improvements with complexity estimates.`;
      ...
      default:
        return 'Please provide a technical analysis of the website data.';
    }
  }
