// packages/next-app/src/app/login/page.tsx
'use client';
...
const Login = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      // On success, the cookie is set automatically by the server.
      // We just need to navigate to the dashboard.
      router.push('/dashboard');
      router.refresh(); // Recommended to reflect server-side changes
  ...
  // The rest of your JSX for the form can remain the same.
  // ... (copy the return (...) block from your original Login.tsx)
  return (
